	...
	public void Check_Other_Menus() throws Exception {
		...
		for (int i = 1; i <= 10; i++) {
			...
			if (Help_And_ELearning.equals(Other_Menus)) {
				...
				System.out.println("Page Header Present on Update My Personal Info Page: "
						+ Update_My_Personal_Info_Page_Header.getText());
			} else if ((Add_A_New_User.equals(Other_Menus))) {
				Add_A_New_User.click();
				Thread.sleep(5000);
				HighlightElement(driver, Add_A_New_User_Page_Header);
				System.out
						.println("Page Header Present on Add A New User Page: " + Add_A_New_User_Page_Header.getText());
			} else if (Grant_Access_TO_A_Report.equals(Other_Menus)) {
				/*
				 * WebDriverWait wait = new WebDriverWait(driver, 10); Alert
				 * alert = wait.until(ExpectedConditions.alertIsPresent());
				 * alert.accept(); Thread.sleep(2000);
				 * first_report_in_grid.click(); Thread.sleep(3000);
				 */
				...
				System.out.println(
						"Page Header Present on Default Language Page: " + Default_Language_Page_Header.getText());
				...
				System.out.println(
						"Page Header Present on Company Statistics Page: " + Company_Statistics_Page_Header.getText());
				...
				try {
					...
					System.out
							.println("Page Header Present on PARCEL Intel Page: " + PARCEL_Intel_Page_Header.getText());
				} catch (Exception e) {
					// e.printStackTrace();
				}
				driver.close();
				...
				System.out.println("Page Header Present on EDR Advisory Partner Portal Page: "
						+ EDR_Advisory_Partner_Portal_Page_Header.getText());
