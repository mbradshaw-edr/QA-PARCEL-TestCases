...
public class Recently_Viewed_Report_Section {
	...
	Recently_Created_Project=excel.Project_Name(1, 0);
	...
	public void Check_Recently_Viewed_Reports() throws Exception{
		...
		System.out.println("Double click on Project_Name in Thirdrow of Main_Grid which is "+TOC_projectname.getText());
		Home_tab.click();
		}catch (Exception e) {
		...
		try {
			...
			System.out.println("Double click on Project_Name in Thirdrow of Main_Grid which is "+classic_TOC_projectname.getText());
		...
		List<WebElement> Viewedreports = driver.findElements(By.xpath("html/body/div[2]/div/div/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/a[2]"));
		...
		JavascriptExecutor JE = (JavascriptExecutor) driver;
		WebElement Element = driver.findElement(By.xpath("html/body/div[2]/div/div/div/div/div/div[1]/div[1]/div/div/div/div/div[1]/div[1]/div/div[1]/a[1]"));
		JE.executeScript("arguments[0].scrollIntoView(true);",Element);
 		Thread.sleep(3000);
		...
		System.out.println("Project Name on project dashboard page which is display after click on first report of recently viewed report: "+PD_projectname.getText());
		Home_tab.click();
		Thread.sleep(5000);
