...
public class Add_Supporting_Documentation {
		...
		for (WebElement A : All_Sections) {
			if ((A.getText()).contains("Document")) {
				...
				if (Document_Name.isEnabled()) {
					...
					Section_Name = driver.findElement(
							By.xpath("//*[@id='appendixTitle" + Current_Sections_Id_array.get(0) + "']/h2"));
	...
	private void Open_Newly_Added_Appendix_Record(String Id) throws Exception {
		...
		WebElement Add_Files = driver.findElement(By.xpath("//*[@id='appendixUploadForm" + Id + "_browse']"));
		List<WebElement> All_Appendix_Records = driver
				.findElements(By.xpath("//*[@id='appendicesFilesTable" + Id + "']/tbody/tr/td[1]/a"));
	...
	public void Add_ADA_Checklist() throws Exception {
		...
		Thread.sleep(2000);
		List<WebElement> All_ADA_YesCheckboxes = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[3]/input"));

		List<WebElement> All_ADA_Comments = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[6]/input"));
		...
		List<WebElement> All_ADA_NoCheckboxes = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[4]/input"));
		...
		List<WebElement> Remaining_ADA_Comments = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[6]/input"));
	...
	public void Add_FHA_Checklist() throws Exception {
		...
		Thread.sleep(2000);
		List<WebElement> All_FHA_YesCheckboxes = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[3]/input"));
		List<WebElement> All_FHA_Comments = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[6]/input"));
		int YesCheckboxes_Counter = 1;
		int NoCheckboxes_Counter = 1;
		...
		Thread.sleep(2000);
		List<WebElement> All_FHA_NoCheckboxes = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[4]/input"));
		...
		List<WebElement> Remaining_FHA_Comments = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td[6]/input"));
	...
	public void Add_User_Questionnaire() throws Exception {
		...
		List<WebElement> All_Questionnaire_NoCheckboxes = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td/table/tbody/tr[3]/td/input[2]"));
		int YesCheckboxes_Counter = 1;
		int NoCheckboxes_Counter = 1;
		...
		Thread.sleep(2000);
		List<WebElement> All_Questionnaire_YesCheckboxes = driver
				.findElements(By.xpath("html/body/center/form/table/tbody/tr/td/table/tbody/tr[2]/td/input[1]"));
		...
		List<WebElement> Remaining_Questionnaire_Comments = driver
				.findElements(By.xpath("//table/tbody/tr[2]/td/textarea"));
