...
import test_cases.Capture_Screenshot;
...
public class Appendices_Subtab {
	...
	private void click_Addfiles(WebElement Add_Files) throws Exception {
		try {
			HighlightElement(driver, Add_Files);
			Add_Files.click();
		} catch (Exception e) {
			Actions builder = new Actions(driver);
			builder.moveToElement(Add_Files).click(Add_Files);
			builder.perform();
		}
		Thread.sleep(3000);
	}
	...
	public void Search_SiteId(int row, int column) throws IOException, Exception {
		...
		Excel_Data excel = new Excel_Data("src\\test\\java\\Test_Data\\Appendices.xlsx");
		String Excel_SiteId = "";
	...
	public void Print_AllSections() throws Exception {
		...
		for (WebElement A : All_Sections) {
			...
			Thread.sleep(5000);
			try {
				WebElement Section_Name_On_Panel = driver
						.findElement(By.xpath("//*[@id='appendixTitle" + Section_Id + "']"));
			...
			if (A.getAttribute("id").equalsIgnoreCase(AllAppendices_Section_Link.getAttribute("id"))) {
				for (int i = 0; i < All_Sections_ID_Onpanel_array.size(); i++) {
					WebElement Section_Name_OnPanel = driver
							.findElement(By.id("" + All_Sections_ID_Onpanel_array.get(i) + ""));
	...
	/*	System.out.println("After click on All Appendices Link then all sections display on panel are:"
				+ All_Sections_Names_Onpanel_array);*/
		Thread.sleep(5000);
	}
	...
	public void Print_All_Legends() throws Exception {
		...
		for (int R = 1; R <= 2; R++) {
			...
			for (int C = 2; C <= 5; C++) {
				WebElement All_Legends = driver
						.findElement(By.xpath("//*[@id='contentappendicesmenu-tab']/div[1]/div/div/table/tbody/tr[" + R
								+ "]/td[" + C + "]/span"));
	...
	public void Check_Appendices_Tab() throws Exception {
		...
		System.out.println(
				"Sub Tabs under Appendices tab: " + Appendices_SubTab.getText() + " and " + Comments_SubTab.getText());
		Print_AllSections();
		Print_All_Legends();
	}
		...
		for (WebElement A : All_Sections) {
			...
			if ((A.getText()).contains("Photo")) {
				...
				if (View_Photo_PDF.isEnabled()) {
					...
					WebElement Add_Files = driver.findElement(
							By.xpath("//*[@id='appendixUploadForm" + All_Sections_Id_array.get(0) + "_browse']"));
					JavascriptExecutor JJ = (JavascriptExecutor) driver;
					JJ.executeScript("arguments[0].scrollIntoView(true);", Add_Files);
					click_Addfiles(Add_Files);
					Capabilities cap = ((RemoteWebDriver) driver).getCapabilities();
					String browserName = cap.getBrowserName().toLowerCase();

					if (browserName.equals("chrome")) {
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG Image Upload for Chrome.exe");
						Thread.sleep(15000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG1 Image Upload for Chrome.exe");
						Thread.sleep(15000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG2 Image Upload for Chrome.exe");
						Thread.sleep(20000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\PNG Image Upload for Chrome.exe");
					} else if (browserName.equals("internet explorer")) {
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG Image Upload for IE.exe");
						Thread.sleep(15000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG1 Image Upload for IE.exe");
						Thread.sleep(15000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG2 Image Upload for IE.exe");
						Thread.sleep(20000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\PNG Image Upload for IE.exe");
					} else {
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG Image Upload for firefox.exe");
						Thread.sleep(15000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG1 Image Upload for firefox.exe");
						Thread.sleep(15000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\JPG2 Image Upload for firefox.exe");
						Thread.sleep(20000);
						click_Addfiles(Add_Files);
						Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\PNG Image Upload for Firefox.exe");
					}
					Thread.sleep(15000);
					JavascriptExecutor JE = (JavascriptExecutor) driver;
	...
	public void Drag_And_Drop_Image() throws Exception {
		...
		for (int i = 1; i <= All_Included_Images_array.size(); i++) {
			...
			if (i == 1) {
				...
				WebElement Destinationlocator = driver.findElement(
						By.id("" + All_Included_Images_array.get(All_Included_Images_array_Size - 1) + ""));
			...
			if (i == All_Included_Images_array_Size) {
				WebElement Sourcelocator = driver.findElement(
						By.id("" + All_Included_Images_array.get(All_Included_Images_array_Size - 1) + ""));
	...
	public void Edit_All_Option() throws Exception {
		...
		for (WebElement I : All_Included_Images) {
			...
			if (Counter == 1) {
				...
				WebElement Edit_Captionbox = driver
						.findElement(By.xpath("//*[@id='divEditCaption" + Image_Id_No + "']"));
		...
		for (WebElement A : All_Sections) {
			...
			if ((A.getText()).contains("Photo")) {
				...
				if (View_Photo_PDF.isEnabled()) {
					...
					WebElement Other_Uploaded_Files = driver.findElement(
							By.xpath("//*[@id='divSectionPhotos" + All_Sections_Id_array.get(0) + "']/h5"));
					...
					List<WebElement> All_Uploaded_PDF = driver.findElements(By.xpath("//*[@id='appendicesFilesTable"
							+ All_Sections_Id_array.get(0) + "']/tbody/tr/td/a[@class='pdf']"));
					int Counter = 1;
					for (WebElement PDF : All_Uploaded_PDF) {
						...
						if (Counter == 1) {
							...
							WebElement Rename_PDF_File = driver.findElement(By.xpath("//*[@id='appendicesFilesTable"
									+ All_Sections_Id_array.get(0) + "']/tbody/tr[2]/td[5]/a[2]"));
							HighlightElement(driver, Rename_PDF_File);
							Rename_PDF_File.click();
							Thread.sleep(5000);

							WebElement Change_PDF_File_Name = driver
									.findElement(By.xpath("//*[@id='appendicesFilesTable" + All_Sections_Id_array.get(0)
											+ "']/tbody/tr[3]/td/form/input[1]"));
							WebElement Go_Button = driver
									.findElement(By.xpath("//*[@id='appendicesFilesTable" + All_Sections_Id_array.get(0)
											+ "']/tbody/tr[3]/td/form/input[5 and @type='button' and @value='Go']"));
							...
							driver.switchTo().alert().accept();
							Thread.sleep(3000);
							WebElement RenamePDF_File = driver.findElement(By.xpath("//*[@id='appendicesFilesTable"
									+ All_Sections_Id_array.get(0) + "']/tbody/tr[2]/td[5]/a[2]"));
							HighlightElement(driver, RenamePDF_File);
							RenamePDF_File.click();
							Thread.sleep(5000);
							WebElement Move_Dropdown = driver.findElement(By.xpath("//*[@id='appendicesFilesTable"
									+ All_Sections_Id_array.get(0) + "']/tbody/tr[3]/td/form/select"));
							WebElement GoButton = driver
									.findElement(By.xpath("//*[@id='appendicesFilesTable" + All_Sections_Id_array.get(0)
											+ "']/tbody/tr[3]/td/form/input[5 and @type='button' and @value='Go']"));
							WebElement Change_PDFFile_Name = driver.findElement(By.xpath("//*[@id='appendicesFilesTable"
									+ All_Sections_Id_array.get(0) + "']/tbody/tr[3]/td/form/input[1]"));
							...
							driver.switchTo().alert().accept();
							Thread.sleep(3000);
							List<WebElement> AllSections = driver
									.findElements(By.xpath("//*[@id='sectionsList']/li/a"));
							for (WebElement B : AllSections) {
								...
								if ((B.getAttribute("data-section-id")).equals(Selected_Dropdown_Option)) {
									...
									List<WebElement> All_PDF = driver
											.findElements(By.xpath("//*[@id='appendicesFilesTable"
													+ Selected_Dropdown_Option + "']/tbody/tr/td/a[@class='pdf']"));
									int counter = 1;
									for (WebElement allPDF : All_PDF) {
										if (counter == 1) {
											...
											WebElement Rename_PDFFile = driver
													.findElement(By.xpath("//*[@id='appendicesFilesTable"
															+ Selected_Dropdown_Option + "']/tbody/tr[2]/td[5]/a[2]"));
											HighlightElement(driver, Rename_PDFFile);
											Rename_PDFFile.click();
											Thread.sleep(5000);
											WebElement Moveto_Dropdown = driver.findElement(
													By.xpath("//*[@id='appendicesFilesTable" + Selected_Dropdown_Option
															+ "']/tbody/tr[3]/td/form/select"));
											WebElement ChangePDFFile_Name = driver.findElement(
													By.xpath("//*[@id='appendicesFilesTable" + Selected_Dropdown_Option
															+ "']/tbody/tr[3]/td/form/input[1]"));
											WebElement go_button = driver.findElement(
													By.xpath("//*[@id='appendicesFilesTable" + Selected_Dropdown_Option
															+ "']/tbody/tr[3]/td/form/input[5 and @type='button' and @value='Go']"));
											...
											for (WebElement C : allsections) {
												...
												if ((C.getAttribute("data-section-id"))
														.equals(Selected_Dropdown_Option)) {
	...
	public void Check_PDF_Exclude_Include_Sort_Delete() throws Exception {
		...
		WebElement Add_Another_File = driver
				.findElement(By.xpath("//*[@id='appendixUploadForm" + Selected_Dropdown_Option + "_browse']"));

		JavascriptExecutor JA = (JavascriptExecutor) driver;
		JA.executeScript("arguments[0].scrollIntoView(true);", Add_Another_File);

		click_Addfiles(Add_Another_File);
		Capabilities cap = ((RemoteWebDriver) driver).getCapabilities();
		String browserName = cap.getBrowserName().toLowerCase();
		if (browserName.equals("chrome")) {
			Runtime.getRuntime().exec("src\\test\\java\\Test_Data\\PDF Upload for Chrome.exe");
		...
		List<WebElement> All_PDFS = driver.findElements(By
				.xpath("//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr/td/a[@class='pdf']"));
		...
		for (WebElement allPDFs : All_PDFS) {
			if (COUNTER == 1) {
				...
				Thread.sleep(5000);
				WebElement Exclude_File = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[2]/td[5]/a[3]"));
				HighlightElement(driver, Exclude_File);
				Exclude_File.click();
				Thread.sleep(8000);
				WebElement Include_File = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[2]/td[5]/a[4]"));
				HighlightElement(driver, Include_File);
				Include_File.click();
				Thread.sleep(8000);
				WebElement Move_Down = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[2]/td[5]/a[7]"));

				HighlightElement(driver, Move_Down);
				Move_Down.click();
				Thread.sleep(8000);
				WebElement Move_Up = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[5]/td[5]/a[6]"));

				HighlightElement(driver, Move_Up);
				Move_Up.click();
				Thread.sleep(8000);
				WebElement Move_Tobottom = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[2]/td[5]/a[8]"));

				HighlightElement(driver, Move_Tobottom);
				Move_Tobottom.click();
				Thread.sleep(8000);
				WebElement Move_Totop = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[5]/td[5]/a[5]"));

				HighlightElement(driver, Move_Totop);
				Move_Totop.click();
				Thread.sleep(8000);

				WebElement Delete_PDF = driver.findElement(By.xpath(
						"//*[@id='appendicesFilesTable" + Selected_Dropdown_Option + "']/tbody/tr[2]/td[5]/a[1]"));
