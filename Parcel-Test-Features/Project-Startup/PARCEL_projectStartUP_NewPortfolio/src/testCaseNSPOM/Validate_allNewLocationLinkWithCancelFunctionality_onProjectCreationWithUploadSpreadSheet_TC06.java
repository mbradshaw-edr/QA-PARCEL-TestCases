...
public class Validate_allNewLocationLinkWithCancelFunctionality_onProjectCreationWithUploadSpreadSheet_TC06 {
	...
	By CancelButton=By.name("cancelAddSite");
	...
	ExcelR1 obj=new ExcelR1("..\\PARCEL_projectStartUP_NewPortfolio\\src\\testData\\TestData_NewPortfolio.xlsx");
	   ...
	   public static void HighlightElement(WebDriver wd, WebElement element) throws InterruptedException
	    ...
	    public Validate_allNewLocationLinkWithCancelFunctionality_onProjectCreationWithUploadSpreadSheet_TC06(WebDriver wd)
		{
			this.wd=wd;
		} 
		...
		public void setValuesOnFields() throws InterruptedException
		{
			...
			{
				WebElement e17=wd.findElement(CancelButton);
