...
public class Validate_ProjectCreatedSuccessfully_lallLinksAvailabilityAndFuctionality_TC22 {
	...
	ExcelR1 obj=new ExcelR1("..\\PARCEL_projectStartUP_NewPortfolio\\src\\testData\\TestData_NewPortfolio.xlsx");
	   ...
	   public Validate_ProjectCreatedSuccessfully_lallLinksAvailabilityAndFuctionality_TC22(WebDriver wd)
		{
			this.wd=wd;
		} 
	   ...
	   public void click_grantAccessLink() throws InterruptedException
		{
			...
			e8.sendKeys(ExcelR1.getData("Grant AccessEntries_ManualPhase",1,1));
			...
			a.sendKeys(ExcelR1.getData("Grant AccessEntries_ManualPhase",1,0));
			Thread.sleep(6000);
			a.accept();
			Thread.sleep(5000);
