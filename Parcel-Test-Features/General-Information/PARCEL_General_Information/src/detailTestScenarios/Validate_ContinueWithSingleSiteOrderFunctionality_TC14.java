...
public class Validate_ContinueWithSingleSiteOrderFunctionality_TC14 {
	...
	public Validate_ContinueWithSingleSiteOrderFunctionality_TC14(WebDriver wd)
	{
		this.wd=wd;
	}
	
	public void click_onContinueWithSingleSiteOrderButton() throws InterruptedException
	{
		...
		WebElement e4=wd.findElement(ContinueWithSingleSiteButton);
		...
		{
			this.click_onContinueWithSingleSiteOrderButton();
		}
