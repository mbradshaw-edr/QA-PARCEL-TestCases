...
public class Validate_WithinDropdownBox_usingTowSearchCriteria_theAadditionalSearchCriteria_TC05 {
	...
	public Validate_WithinDropdownBox_usingTowSearchCriteria_theAadditionalSearchCriteria_TC05(WebDriver wd)
	{
		this.wd=wd;
	}
	...
	public void selectPCA_withInDDBox_thenClickedOnSubmitButton_fourthAttempt() throws InterruptedException
	{
		...
		e1.click();
		Select s1=new Select(e1);
		s1.selectByVisibleText("Phase I ESA");
		Thread.sleep(1000);
		e1.click();
