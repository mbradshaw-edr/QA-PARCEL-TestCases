...
public class Validate_clikingOnAccessLink_underResultViewGrid_TC08 {
	...
	public Validate_clikingOnAccessLink_underResultViewGrid_TC08(WebDriver wd)
	{
		this.wd=wd;
	}
	...
	public void click_onAccessLink_underResultViewGrid() throws InterruptedException
	{
		WebElement e=wd.findElement(FirstAccessLnk_underResultViewGrid);
		HighlightElement(wd, e);
		e.click();
		Thread.sleep(4000);
		...
		WebElement e1=wd.findElement(AccessManagementPageHeader);
		HighlightElement(wd, e1);
	...
	{
		this.click_onAccessLink_underResultViewGrid();
