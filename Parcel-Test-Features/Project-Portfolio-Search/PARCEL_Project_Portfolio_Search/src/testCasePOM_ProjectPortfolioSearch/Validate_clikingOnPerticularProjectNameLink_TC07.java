...
public class Validate_clikingOnPerticularProjectNameLink_TC07 {
	...
	public Validate_clikingOnPerticularProjectNameLink_TC07(WebDriver wd)
	{
		this.wd=wd;
	}
	...
	{ 
		...
		Thread.sleep(2000);
			...
			WebElement e5=wd.findElement(WithIn_AllReportTypeDD);
			HighlightElement(wd, e5);
			e5.click();
			Select s5=new Select(e5);
			s5.selectByVisibleText("All Report Types");
			Thread.sleep(1000);
			e1.click();
	...
	public void click_onProjectNameLink_underResultViewGrid() throws InterruptedException
	{
		WebElement e=wd.findElement(FirstProjectNameLink_underResultViewGrid);
		HighlightElement(wd, e);
		e.click();
		Thread.sleep(4000);
		...
		WebElement e1=wd.findElement(ProjectDashboard_pageHeader);
		HighlightElement(wd, e1);
	...
	public void mainMethod() throws InterruptedException
	{
		...
		this.click_onProjectNameLink_underResultViewGrid();
